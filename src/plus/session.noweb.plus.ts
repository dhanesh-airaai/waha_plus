...
export class WhatsappSessionNoWebPlus extends WhatsappSessionNoWebCore {
    ...
    fileToMessage(
        ...
        if (!("url" in file || "data" in file)) {
            throw new UnprocessableEntityException("Either file.url or file.data must be specified.")
        }
    ...
    protected async downloadMedia(message) {
        ...
        const hasMedia = messageType === 'imageMessage' || messageType == "audioMessage" || messageType == "videoMessage"
